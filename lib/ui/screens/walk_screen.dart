...
import "package:gym/models/walkthrough.dart";
...
class WalkthroughScreen extends StatefulWidget {
  ...
  final List<Walkthrough> pages = [
    Walkthrough(
      ...
      title: "With us will be more fit",
    ),
    Walkthrough(
      icon: Image(
      ...
      widgets.add(
        new Container(
          ...
          child: ListView(
            children: <Widget>[
              Padding(
                  padding: const EdgeInsets.only(top: 70.0), child: page.icon),
              Padding(
                padding:
            ...
            children: <Widget>[
              ...
              Padding(
                padding:
                    const EdgeInsets.only(top: 50.0, right: 15.0, left: 15.0),
                child: Text(
                  "Our goals is a soild body and pure mind",
                  softWrap: true,
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    color: Colors.white,
